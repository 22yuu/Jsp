...
<body>
	<div id="wrapper">
		<header>
			<a href="#" class="logo"><img src="/Farmstory2/img/logo.png"
				alt="로고" /></a>
			<p>
			...
			<ul class="gnb">
				...
				<li><a
					href="/Farmstory2/board/list.do?group=market&cate=market"><img
						src="/Farmstory2/img/head_menu_badge.png" alt="30%" />장보기</a></li>
				<li><a
					href="/Farmstory2/board/list.do?group=croptalk&cate=story">농작물이야기</a></li>
				<li><a href="/Farmstory2/board/list.do?group=event&cate=event">이벤트</a></li>
				<li><a
					href="/Farmstory2/board/list.do?group=community&cate=notice">커뮤니티</a></li>
			</ul>
		</header>