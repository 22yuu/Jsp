        ...
        <div id="sub">
            ...
            <section class="cate3">
                <aside>
                    ...
                    <ul class="lnb">
                        <li><a href="/Farmstory1/croptalk/story.html">농작물이야기</a></li>
                        <li class="on"><a href="/Farmstory1/croptalk/grow.html">텃밭가꾸기</a></li>
                        <li><a href="/Farmstory1/croptalk/school.html">귀농학교</a></li>
                    </ul>
